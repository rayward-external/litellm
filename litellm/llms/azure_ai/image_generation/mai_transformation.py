...
class AzureFoundryMAIImageGenerationConfig(BaseImageGenerationConfig):
    ...
    def _map_size_param(self, size: str, optional_params: dict, model: str) -> None:
        ...
        optional_params["width"] = (
            width  # rebind-ok: normalizes width/height back into optional_params after validation
        )
        optional_params["height"] = (
            height  # rebind-ok: normalizes width/height back into optional_params after validation
        )
